...
with torch.cuda.device(0):
    net = network.LiteDenseNet_modify(BAND, CLASSES_NUM)
    # net = network.LiteDenseNet(BAND, CLASSES_NUM)
    flops, params = get_model_complexity_info(net, (1, 11, 11, BAND), as_strings=True, print_per_layer_stat=True)
...
for index_iter in range(ITER):
    ...
    train.train(net, train_iter, valida_iter, loss, optimizer,
                device, epochs=num_epochs)
